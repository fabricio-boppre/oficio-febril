...
- As imagens que serão publicadas junto com os textos devem ter no máximo 920px de largura, uma vez que esta é a largura máxima do site. Images maiores serão redimensionadas para este limite, porém o peso dos arquivos permanecerá desnecessariamente o mesmo, o que trará prejuízos para a performance do site.
- Imagens publicadas com menos do que 920px são exibidas com suas medidas originais. O site não aumenta artificialmente as medidas das imagens.
...
- Para a publicação de links internos (links que apontam para telas ou arquivos dentro do próprio site), você pode utilizar o formato padrão do Markdown com o endereço completo desejado para o link:
